            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click="changeOrder('1')">
                  <a >综合<span v-show="isOne" class="iconfont" :class="{'icon-upward': isAsc,'icon-down': isDesc}"></span></a>
                </li>
                <li :class="{active: isTwo}" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-upward': isAsc,'icon-down': isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
import Pagination from '../../components/Pagination/index.vue';
  export default {
    ...
    data(){
      return{
        ...
        searchParams:{
          ...
          "categoryName": "",
          "keyword": "",
          //1是综合 2是价格 升序asc 降序desc
          "order": "1:desc", //排序 初始状态应该是综合、降序
          "pageNo": 1, // 分页器，这类数据默认是1
          "pageSize": 10,
          "props": [],
          "trademark": "",
    ...
    mounted(){
      //发请求之前带给服务器的参数【searchParams参数发生变化有数值带给服务器】
      this.getData()
    },
    computed:{
      //传递的是数组
